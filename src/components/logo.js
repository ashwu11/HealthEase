...
const Logo = () => {
    const images = [
        {
            ...
            alt: "Image 1",
            className: "shrink-0 aspect-square fill-black w-[10vw] rounded-2xl",
        },
        {
            ...
            alt: "Image 2",
            className: "shrink-0 self-start mt-5 aspect-[1.09] w-[10vw]",
        },
        {
            ...
            alt: "Image 3",
            className: "shrink-0 my-auto aspect-[1.82] w-[10vw]",
        },
        {
    ...
    return (
        <div className="flex flex-col justify-center w-[10vw]">
            <div className="flex flex-col w-full rounded-2xl bg-zinc-100 h-[10vw]">
