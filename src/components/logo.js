...
const ImageGrid = () => {
    const images = [
        {
            ...
            alt: "Image 1",
            className: "shrink-0 aspect-square fill-black w-[74px]",
        },
        {
    ...
    return (
        <div className="flex flex-col justify-center max-w-[148px]">
            <div className="flex flex-col w-full rounded-2xl bg-zinc-100 h-[148px]">
